...
public class DocumentPermissionServiceTest {
    ...
    public void createDocumentPermission() throws AccessDeniedException {
        ...
        // Call service
        DocumentPermission result = documentPermissionService.createDocumentPermission(documentId, username, role);
    ...
    public void deleteByDocumentIdAndUsername_cannotRemoveOwner() {
        ...
        IllegalArgumentException ex = assertThrows(IllegalArgumentException.class,
                () -> documentPermissionService.deleteByDocumentIdAndUsername(documentId, ownerUsername));
